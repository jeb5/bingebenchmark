...
import { Chart as ChartJS, LineElement, PointElement, LinearScale, Title, CategoryScale, Tooltip, ChartOptions, Tick } from "chart.js";
          ...
          datasets: [
            ...
            },
            {
              ...
              data: showDetails.analysis?.trendlines?.show
                ? [showDetails.analysis.trendlines.show.drawPoints.start, showDetails.analysis.trendlines.show.drawPoints.end]
                : [],
