		...
		<div className={styles.outerFooter}>
			...
			<div className={styles.attributionContainer}>
				<div>
					...
					<div>
						Rating data provided by TRAKT. This product uses the TRAKT API but is not endorsed or certified by TRAKT.
						TV.
					</div>
				</div>
				<div>
					...
					<div>
						Show metadata provided by The Movie Database. This product uses the TMDB API but is not endorsed or
						certified by TMDB.
					</div>
				</div>
			</div>
